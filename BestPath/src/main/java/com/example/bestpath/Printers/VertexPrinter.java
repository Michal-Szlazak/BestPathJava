...
public class VertexPrinter {
    ...
    private final Circle[] vertexes;
    private final Group vertexesGroup;

    public VertexPrinter(int rows, int columns, Circle[] vertexes, double radius, Group vertexesGroup){
        this.rows = rows;
